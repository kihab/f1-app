...
class FontManagerTests: XCTestCase {
    ...
    func testFontUsageInText() {
        ...
        let _ = Text("Title").font(FontManager.title())
        let _ = Text("Headline").font(FontManager.headline())
        let _ = Text("Subheadline").font(FontManager.subheadline())
        let _ = Text("Body").font(FontManager.body())
        let _ = Text("Caption").font(FontManager.caption())
        let _ = Text("Caption2").font(FontManager.caption2())
